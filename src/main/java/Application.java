...
public class Application {
	...
	public void sendAcmeretailC360CustomerinsightGeneratedV0InsighttypeCustomerid(
		CustomerInsight payload, String insighttype, String customerid
		) {
		String topic = String.format("acmeretail/c360/customerinsight/generated/v0/%s/%s",
